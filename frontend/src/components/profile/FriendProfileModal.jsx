...
import { X, Eye, Bookmark, Film, Star, Heart } from 'lucide-react';
          ...
          <div className="max-h-[85vh] overflow-y-auto overscroll-contain">
            <div className="p-5 sm:p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full overflow-hidden shrink-0 bg-[#1c1512] border-2 border-amber/20">
                  {profile.picture ? (
                    <img src={resolveAvatarUrl(profile.picture)} alt={profile.name || profile.username}
