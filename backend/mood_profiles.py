...
MOOD_PROFILES = {
    ...
    "kahkaha": {
        ...
        "intent": "Hafif, eğlenceli, komik, hızlı rahatlatan. Live-action komedi öncelikli. Absürt komedi, buddy comedy, feel-good comedy, dark comedy, komedi-dram da olabilir ama komedi ağırlıklı olmalı.",
        ...
        "positive_keywords": ["comedy", "funny", "hilarious", "laugh", "satire", "parody", "stand-up", "slapstick", "buddy comedy",
                              ...
                              "dark comedy", "dry humor", "mockumentary", "sitcom", "screwball",
                              # Türkçe
                              "komedi", "komik", "gülmek", "kahkaha", "espri", "şaka", "absürt", "parti",
                              "yanlış anlama", "sarhoş", "kaos", "saçma", "eğlenceli", "mizah", "kara mizah"],
        "negative_keywords": ["horror", "war", "tragedy", "psychological", "depression", "death",
                              "grief", "cancer", "funeral", "suicide", "torture", "genocide", "slavery",
                              "korku", "savaş", "trajedi", "psikolojik", "depresyon", "ölüm", "cenaze"],
        "tone": {
            "atmosphere": "fun",
            "tempo": "fast",
    ...
    "sipsak": {
        "title": "Şipşak",
        "music_style": "Minimal Ambient & Lo-fi",
        "description": "Üstad der ki: 'Zamanın az, sinema aşkının sonsuz olduğu o dar aralıklar için... Perdeyi hemen açıyoruz; saniyelerin bile bir başyapıta dönüştüğü, vakit nakittir diyen ama sanattan ödün vermeyen kompakt sinematik vuruşlar.'",
        "intent": "Kısa filmler, antoloji bölümleri, 45-90 dakikalık kompakt başyapıtlar. Vurucu ve etkili anlatım, minimal sürede maksimum duygu. Bağımsız kısa filmler, deneysel kısalar, belgesel kısaları, şiirsel kompakt yapımlar.",
        "positive_genres": [18, 10749, 35, 99, 14],
        "negative_genres": [28, 878, 27, 53, 80, 10752],
        "positive_keywords": ["short", "kısa", "short film", "kısa film", "compact", "kompakt", "anthology", "antoloji", "mini", "minimal", "vurucu", "bağımsız", "deneysel", "poetic", "şiirsel", "independent", "festival short", "bite-sized", "quick", "hızlı", "sipsak", "miniature"],
        "negative_keywords": ["epic", "blockbuster", "long", "uzun", "three-hour", "üç saat", "franchise", "seri", "sequel", "devam"],
        "tone": {
            "atmosphere": "intimate",
            "tempo": "medium_to_fast",
            "film_type": "indie_and_festival",
    ...
    "kadraj-estetigi": {
        ...
        "intent": "Görsel şölen, sinematografi, estetik kompozisyon, renk paleti, simetri. Yüksek prodüksiyon değeri, usta işi görüntü yönetimi. Kubrick, Denis Villeneuve, Wes Anderson, Terrence Malick tarzı. Savaş filmleri de olabilir (1917, Dunkirk gibi görsel şölen olanlar).",
        "positive_genres": [18, 878, 53, 9648, 12, 14, 10752],
        "negative_genres": [35, 10751, 16, 10402, 37],
        "positive_keywords": ["cinematography", "visual masterpiece", "stunning visuals", "symmetry", "color palette", "neo-noir photography",
                              ...
                              "long take", "one shot", "natural light", "golden hour", "landscape",
        ...
        "popularity_policy": "no_restriction",
        "tmdb_params": {
            "without_genres": "35,10751,16,10402,37",
            "sort_by": "vote_average.desc",
            "min_vote_average": 6.5,
            "min_vote_count": 100,
        },
