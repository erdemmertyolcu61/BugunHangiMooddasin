...
class ClaudeService:
    ...
    async def analyze_movie(self, title: str, overview: str, ratings: dict,
        ...
        prompt = (
            ...
            "- Spoiler YASAK.\n\n"
            "Örnek iyi notlar:\n"
            "- 'Üstadın Notu: Jenerik akarken koltuğunuzda kıpırdamadan oturacaksınız. Bu film sessizce içinize giriyor ve bir daha çıkmıyor.'\n"
            ...
            "- 'Üstadın Notu: 80lerin neon sokaklarında kaybolan bir şaheser. Synth müzikleri hâlâ kulaklarımda çınlıyor.'\n\n"
