...
class MoodWeightEnhancer:
    ...
    ENHANCED_WEIGHTS: dict[str, dict[str, float]] = {
        ...
        # ── Soyut / metaforik (yeni) ──
        "kaybolmak":     {"karmakar": 0.7, "yolculuk": 0.5, "zihin": 0.5},
        "kaybol":        {"karmakar": 0.6, "yolculuk": 0.4, "zihin": 0.4},
        "rüya gibi":     {"karmakar": 0.6, "sessiz": 0.4, "kadraj-estetigi": 0.3},
        "başka dünya":   {"karmakar": 0.6, "yolculuk": 0.5},
        "başka evren":   {"karmakar": 0.6, "yolculuk": 0.5, "zihin": 0.4},
        "sessiz çığlık": {"sessiz": 0.8, "gozyasi": 0.5},
        "mavi hüzün":    {"gozyasi": 0.8, "sessiz": 0.6, "kalp": 0.4},
        "içimde fırtına":{"deep-chills": 0.6, "gozyasi": 0.5, "zihin": 0.4},
        "bulut üstü":    {"sessiz": 0.7, "battaniye": 0.5, "yolculuk": 0.3},
        "derin su":      {"sessiz": 0.7, "deep-chills": 0.5, "zihin": 0.3},
        "kendimi kaybet":{"karmakar": 0.6, "yolculuk": 0.5, "sessiz": 0.3},
        "ruh dinlen":    {"battaniye": 0.8, "sessiz": 0.6, "kalp": 0.3},
        "zihin dinlen":  {"sessiz": 0.7, "battaniye": 0.5, "zihin": 0.3},
        "düşünce kaçış": {"kahkaha": 0.5, "yolculuk": 0.5, "battaniye": 0.4},
        "nefes almak":   {"battaniye": 0.7, "sessiz": 0.6, "yolculuk": 0.4},
        "iç huzur":      {"battaniye": 0.8, "sessiz": 0.7, "kalp": 0.5},
        "boşlukta süzül":{"sessiz": 0.9, "zihin": 0.6, "karmakar": 0.4},
        "zaman durmuş":  {"zamanyolcusu": 0.7, "sessiz": 0.6, "zihin": 0.4},
        # ── Argo / internet ek ──
        "çerezlik":      {"sipsak": 0.7, "kahkaha": 0.6, "adrenalin": 0.3},
        "sarmıyor":      {"kalp": -0.5, "sessiz": -0.3},
        "sarıyor":       {"battaniye": 0.6, "kalp": 0.5, "kahkaha": 0.3},
        "akıcı":         {"adrenalin": 0.6, "sipsak": 0.5},
        "boş film":      {"kalp": 0.5, "sessiz": 0.4},
        "aşırı iyi":     {"kahkaha": 0.7, "adrenalin": 0.5},
        "vibe":          {"gece": 0.5, "sessiz": 0.4, "kahkaha": 0.3},
        "aesthetic":     {"kadraj-estetigi": 0.9, "sessiz": 0.4},
    }
