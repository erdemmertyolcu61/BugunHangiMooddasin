...
THEMES = [
    ...
    {"key": "zaman", "triggers": ["zaman yolculugu", "zamanda yolculuk", "zaman makinesi", "time travel"], "terms": ["time travel"], "genres": [878], "label": "Zaman yolculuğu filmleri", "ustad": "Geçmiş, gelecek ve aradaki paradokslar — zihnini bükmeye hazır ol."},
    {"key": "soygun", "triggers": ["soygun", "soygunu", "vurgun", "heist"], "terms": ["heist"], "genres": [80, 53], "label": "Soygun filmleri", "ustad": "Kusursuz plan, son saniye sürprizi — adrenalin dolu vurgunlar."},
    ...
    {"key": "hayatta_kalma", "triggers": ["hayatta kalma", "hayatta kal", "felaket", "afet", "survival"], "terms": ["survival", "disaster"], "genres": [], "label": "Hayatta kalma/felaket filmleri", "ustad": "İnsanın en çıplak hâli: hayatta kalma içgüdüsü."},
    ...
    {"key": "serikatil", "triggers": ["seri katil", "katil temali", "serial killer"], "terms": ["serial killer"], "genres": [53, 80], "label": "Seri katil filmleri", "ustad": "Karanlığın en soğuk yüzü — zihnine işleyecek gerilimler."},
    # ── Uğraş / sanat / spor ──
